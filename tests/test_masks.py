...
def test_value_get_mask_accout():
    assert get_mask_account("dsadsdsad") == "Номер счета состоит оз 20 цифрр. Вводите номер счета без пробелов и знаков припенания"
    assert get_mask_account("546161") == "Номер счета состоит оз 20 цифрр. Вводите номер счета без пробелов и знаков припенания"
    assert get_mask_account("8494dfsf/.") == "Номер счета состоит оз 20 цифрр. Вводите номер счета без пробелов и знаков припенания"
